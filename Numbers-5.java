...
//5. Write a Java program to find the number of seed Lychrel number candidates
// and related numbers for n in the range 1..10000 inclusive. (With that iteration limit of 500).
//        A Lychrel number is a natural number that cannot form a palindrome
// through the iterative process of repeatedly reversing its digits and adding the resulting numbers.
